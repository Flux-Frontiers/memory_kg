...
Click subcommand for launching the MemoryKG visualizer:
...
def viz(db: str, port: str, no_browser: bool) -> None:
    """Launch the MemoryKG Streamlit visualizer."""
    ...
    click.echo(f"Launching MemoryKG Explorer on http://localhost:{port}")
