...
## Run: `results_bge_haystack` (n=500)
...
## Run: `results_bge_haystack_doc` (n=500)
...
| Question Type | n | Recall@5 | Recall@10 | NDCG@10 |
|---|--:|--:|--:|--:|
| knowledge-update | 78 | 0.974 | 0.974 | 0.886 |
| multi-session | 133 | 0.977 | 0.992 | 0.917 |
| single-session-assistant | 56 | 0.964 | 0.982 | 0.948 |
| single-session-preference | 30 | 0.800 | 0.867 | 0.727 |
| single-session-user | 70 | 0.743 | 0.843 | 0.679 |
| temporal-reasoning | 133 | 0.955 | 0.962 | 0.866 |

## Key Findings

- **Top-1 recall:** 78.0% — immediate precision of the semantic seed
- **Top-5 recall:** 92.6%
- **Top-10 recall:** 95.2%
- **Top-50 recall (coverage ceiling):** 100.0%
...
**24 / 500** questions had zero sessions retrieved in top-10.

<details>
<summary>Show all 24 missed question IDs</summary>
