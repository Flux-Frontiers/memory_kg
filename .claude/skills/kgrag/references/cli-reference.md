...
**Warning:** Only removes the registry entry, not the actual database files. To fully clean up, manually delete the `.codekg/`, `.memorykg/`, or `.metakg/` directories.
...
export DOCKG_MODEL_DIR=$HOME/.models/memorykg
```
