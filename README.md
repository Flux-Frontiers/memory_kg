...
[![Version](https://img.shields.io/badge/version-0.10.0-blue.svg)](https://github.com/Flux-Frontiers/memory_kg/releases)
...
> Suchanek, E. G. (2026). *MemoryKG: Hybrid Semantic-Graph Knowledge Base for Conversational Memory* (Version 0.10.0) [Software]. Flux-Frontiers. https://github.com/Flux-Frontiers/memory_kg
